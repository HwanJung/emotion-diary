...
class Settings(BaseSettings):
    # PostgreSQL
    postgres_host: str = Field(validation_alias="DB_HOST")
    postgres_port: int = Field(validation_alias="DB_PORT")
    postgres_db: str = Field(validation_alias="DB_NAME")
    postgres_user: str = Field(validation_alias="DB_USERNAME")
    ...
    rabbitmq_username: str = Field(validation_alias="RABBITMQ_USERNAME")
